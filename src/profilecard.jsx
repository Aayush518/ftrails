...
const ProfileCard = () => {
  return (
    <div className="max-w-full flex items-center justify-center lg:justify-start h-auto lg:h-screen flex-wrap mx-auto my-64 lg:my-0">
      <div id="profile" className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none bg-white opacity-75 mx-6 lg:mx-0">
        <div className="p-4 md:p-12 text-center lg:text-left">
          <div className="block lg:hidden rounded-full mx-auto -mt-52 h-48 w-48 bg-cover bg-center" style={{ backgroundImage: "url('https://source.unsplash.com/MP0IUfwrn0A')" }}></div>
          <h1 className="text-3xl font-bold pt-8 lg:pt-0">Rita Shrestha</h1>
          ...
          <p className="pt-8 text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate aliquam earum aut ullam assumenda commodi tempora qui molestias voluptate asperiores voluptatem quaerat ipsum ex quibusdam sed cum, ut itaque dolorem.</p>
